...
func (ALCSyncCommandIdentifier) Descriptor() protoreflect.EnumDescriptor {
	return file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_enumTypes[0].Descriptor()
}

func (ALCSyncCommandIdentifier) Type() protoreflect.EnumType {
	return &file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_enumTypes[0]
}
...
func (ALCSyncCommandIdentifier) EnumDescriptor() ([]byte, []int) {
	return file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescGZIP(), []int{0}
}
...
func (x *ALCSyncCommand) Reset() {
	*x = ALCSyncCommand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes[0]
...
func (x *ALCSyncCommand_AppTimeReq) Reset() {
	*x = ALCSyncCommand_AppTimeReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ALCSyncCommand_AppTimeReq) Descriptor() ([]byte, []int) {
	return file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ALCSyncCommand_AppTimeAns) Reset() {
	*x = ALCSyncCommand_AppTimeAns{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ALCSyncCommand_AppTimeAns) Descriptor() ([]byte, []int) {
	return file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescGZIP(), []int{0, 1}
}
...
var file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x63, 0x73, 0x79, 0x6e, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x74,
	...
	0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x03, 0x0a, 0x0e, 0x41, 0x4c,
...
var (
	file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescOnce sync.Once
	file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescData = file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDesc
)

func file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescGZIP() []byte {
	file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescOnce.Do(func() {
		file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescData = protoimpl.X.CompressGZIP(file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescData)
	})
	return file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDescData
}

var file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_goTypes = []interface{}{
...
var file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_depIdxs = []int32{
...
func init() { file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_init() }
func file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_init() {
	if File_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_goTypes,
		DependencyIndexes: file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_depIdxs,
		EnumInfos:         file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_enumTypes,
		MessageInfos:      file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_msgTypes,
	}.Build()
	File_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto = out.File
	file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_rawDesc = nil
	file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_goTypes = nil
	file_ttn_lorawan_v3_applicationserver_integrations_alcsync_proto_depIdxs = nil
}
